...
<div class="booknow-wrap">
    ...
    ?>
        <div class="booknow-card">
            <div class="booknow-card-header">
                <h2>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=book-now-bookings')); ?>" class="booknow-back-link">
                ...
                <div class="booknow-booking-actions">
                    <?php if ($booking->status === 'pending') : ?>
                        <a href="<?php echo esc_url(admin_url('admin.php?page=book-now-bookings&id=' . $booking->id . '&action=confirm&_wpnonce=' . $confirm_nonce)); ?>" class="button button-primary">
                    ...
                    <?php if (!in_array($booking->status, array('cancelled', 'completed'))) : ?>
                        <a href="<?php echo esc_url(admin_url('admin.php?page=book-now-bookings&id=' . $booking->id . '&action=cancel&_wpnonce=' . $confirm_nonce)); ?>" class="button" onclick="return confirm('<?php esc_attr_e('Are you sure you want to cancel this booking?', 'book-now-kre8iv'); ?>');">
                            <span class="dashicons dashicons-no"></span> <?php esc_html_e('Cancel', 'book-now-kre8iv'); ?>
                        </a>
                    <?php endif; ?>
                    <?php if ($booking->status === 'confirmed') : ?>
                        <a href="<?php echo esc_url(admin_url('admin.php?page=book-now-bookings&id=' . $booking->id . '&action=complete&_wpnonce=' . $confirm_nonce)); ?>" class="button">
                            <span class="dashicons dashicons-saved"></span> <?php esc_html_e('Mark Complete', 'book-now-kre8iv'); ?>
                        </a>
                    <?php endif; ?>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=book-now-bookings&id=' . $booking->id . '&action=resend_email&_wpnonce=' . $confirm_nonce)); ?>" class="button">
                        <span class="dashicons dashicons-email-alt"></span> <?php esc_html_e('Resend Email', 'book-now-kre8iv'); ?>
                    </a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=book-now-bookings&id=' . $booking->id . '&action=sync_calendar&_wpnonce=' . $confirm_nonce)); ?>" class="button">
                        <span class="dashicons dashicons-calendar"></span> <?php esc_html_e('Sync Calendar', 'book-now-kre8iv'); ?>
                    </a>
                </div>
            </div>
                    ...
                    <div class="booknow-detail-section">
                        ...
                        <table class="booknow-detail-table">
                            ...
                            <tr>
                                ...
                                <td><?php echo esc_html($booking->duration); ?> <?php esc_html_e('minutes', 'book-now-kre8iv'); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($booking->google_event_id)) : ?>
                                        ...
                                        <code style="font-size: 11px; margin-left: 5px;"><?php echo esc_html($booking->google_event_id); ?></code>
                                    <?php else : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($booking->microsoft_event_id)) : ?>
                                        <span class="dashicons dashicons-yes-alt" style="color: #46b450;"></span>
                                        <?php esc_html_e('Synced', 'book-now-kre8iv'); ?>
                                        <code style="font-size: 11px; margin-left: 5px;"><?php echo esc_html($booking->microsoft_event_id); ?></code>
                                    <?php else : ?>
                                        <span class="dashicons dashicons-minus" style="color: #999;"></span>
                                        <?php esc_html_e('Not synced', 'book-now-kre8iv'); ?>
                                    <?php endif; ?>
    ...
    <?php elseif ($booking_id && !$booking) : ?>
        ...
        <p><a href="<?php echo esc_url(admin_url('admin.php?page=book-now-bookings')); ?>">&larr; <?php esc_html_e('Back to bookings list', 'book-now-kre8iv'); ?></a></p>
